...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE expense (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, time TEXT)");
    ...
    public void edit(String idToUpdate, String newTitle, String newTime){
       try{
           SQLiteDatabase db = this.getWritableDatabase();

           String updateQuery = "UPDATE expense SET title = '" + newTitle + "', time = '" + newTime + "' WHERE id = " + idToUpdate;
